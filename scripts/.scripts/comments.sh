...
function usage()
{
    ...
    echo -e "Example:"
    echo -e ""
    echo -e "   1) Create a file named LargestNumber.py, and add Copyright & Problem description"
    echo -e "   ${0} https://leetcode.com/problems/largest-number/"
    echo -e ""
    echo -e "   2) Add Copyright & Problem description into existed file"
    echo -e "   ${0} https://leetcode.com/problems/largest-number/ LargestNumber.py"
    echo -e ""
}

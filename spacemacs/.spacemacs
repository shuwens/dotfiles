...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                      ...
                                      material-theme
                                      ;; dark theme
                                      srcery-theme nord-theme gruvbox-theme
                                      ;; light theme
                                      doneburn-theme
                                      ;; new batch
                                      ujelly-theme melancholy-theme
                                      doom-themes kaolin-themes alect-themes
...
in the dump."
  ...
  (with-eval-after-load 'rust-mode
    (add-hook 'rust-mode-hook (lambda() (define-key evil-normal-state-local-map
                                          (kbd "C-M-,")
                                          #'spacemacs/racer-describe))))
  (with-eval-after-load 'rust-mode
    (add-hook 'rust-mode-hook (lambda() (define-key evil-normal-state-local-map
                                          (kbd "C-M-r")
                                          #'racer-describe-tooltip))))
  (with-eval-after-load 'rust-mode
    (add-hook 'rust-mode-hook (lambda() (define-key evil-normal-state-local-map
                                          (kbd "C-M-*")
                                          #'pop-tag-mark))))
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(sayid mvn maven-test-mode intero hlint-refactor hindent haskell-snippets groovy-imports pcache flycheck-haskell erlang ensime sbt-mode scala-mode eclim dante lcr company-ghci company-ghc ghc haskell-mode cmm-mode clojure-cheatsheet clj-refactor inflections edn peg cider-eval-sexp-fu cider queue clojure-mode yapfify yaml-mode xterm-color ws-butler winum which-key wgrep web-mode web-beautify volatile-highlights vi-tilde-fringe uuidgen use-package unfill ujelly-theme treemacs-projectile treemacs-evil toml-mode toc-org tern tagedit symon string-inflection stickyfunc-enhance srcery-theme spaceline-all-the-icons smex smeargle slim-mode shm shell-pop scss-mode sass-mode restart-emacs request rainbow-mode rainbow-identifiers rainbow-delimiters racer pyvenv pytest pyenv-mode py-isort pug-mode protobuf-mode popwin pippel pipenv pip-requirements persp-mode pcre2el pcap-mode password-generator paradox overseer orgit org-ref org-projectile org-present org-pomodoro org-mime org-download org-bullets org-brain open-junk-file nord-theme nameless mwim multi-term move-text mmm-mode minimap melancholy-theme meghanada material-theme markdown-toc magit-svn magit-gitflow macrostep lsp-ui lsp-rust lsp-python lsp-javascript-typescript lorem-ipsum livid-mode live-py-mode lispy link-hint langtool kaolin-themes json-navigator json-mode js2-refactor js-doc ivy-xref ivy-rtags ivy-purpose ivy-hydra insert-shebang indent-guide importmagic impatient-mode ibuffer-projectile hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-make gruvbox-theme groovy-mode graphviz-dot-mode gradle-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link gh-md function-args font-lock+ flyspell-popup flyspell-correct-ivy flycheck-rust flycheck-rtags flycheck-pos-tip flycheck-bashate flx-ido fix-word fish-mode fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-cleverparens evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help emmet-mode elisp-slime-nav editorconfig dumb-jump doom-themes doneburn-theme disaster diminish deft define-word darktooth-theme darkroom cython-mode cquery counsel-projectile counsel-css company-childframe column-enforce-mode color-theme-sanityinc-tomorrow color-identifiers-mode cmake-mode cmake-ide clean-aindent-mode clang-format centered-cursor-mode cargo auto-highlight-symbol auto-dictionary auto-compile auctex-latexmk anaconda-mode alect-themes aggressive-indent ace-link academic-phrases)))
  (custom-set-faces

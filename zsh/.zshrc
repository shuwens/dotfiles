...
ZSH_THEME="candy"    #powerline kardan agnoster af-magic bira clean candy gentoo terminalparty
...
hash -d projs=~/git/networking/cs168/prog_assign/
...
# Backupp
alias Backup-local='sudo ~/.scripts/laptop_backup_local.sh'
...
## DEs
alias Cinnamon='sudo ~/.scripts/cinnamon.sh'
alias Awesome='sudo ~/.scripts/awesome.sh'
...
## Theming
#alias Msjche='~/git/Scripts/Theming/msjche.sh'

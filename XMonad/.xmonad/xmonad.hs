...
-- Options
{-# LANGUAGE DeriveDataTypeable, FlexibleContexts, TypeSynonymInstances, NoMonomorphismRestriction, MultiParamTypeClasses, ImplicitParams #-}
...
dzenFont       = "-*-montecarlo-medium-r-normal-*-16-*-*-*-*-*-*-*"
...
boxLeftIcon    = "/home/shwsun/.icons/xbm_icons/subtle/boxleft.xbm"  --left icon of dzen boxes
boxLeftIcon2   = "/home/shwsun/.icons/xbm_icons/subtle/boxleft2.xbm" --left icon2 of dzen boxes
boxRightIcon   = "/home/shwsun/.icons/xbm_icons/subtle/boxright.xbm" --right icon of dzen boxes
xDefRes        = 1366 --no longer used
yDefRes        = 768  --no longer used
panelHeight    = 18   --16height of top and bottom panels
boxHeight      = 16   --14height of dzen logger box
...
calendarCA :: CA
calendarCA = CA
	{ leftClickCA   = "/home/shwsun/bin/dzencal.sh"
	, middleClickCA = "/home/shwsun/bin/dzencal.sh"
	, rightClickCA  = "/home/shwsun/bin/dzencal.sh"
	, wheelUpCA     = "/home/shwsun/bin/dzencal.sh"
	, wheelDownCA   = "/home/shwsun/bin/dzencal.sh"
	}
...
myStartupHook =
	...
	(spawn "/usr/bin/feh --bg-scale ~/.xmonad/wallpapers/black.png") <+>
	...
	(spawn "/home/shwsun/.xmonad/apps/haskell-cpu-usage.out 5") <+>
...
-- Tabbed transformer (W+f) transformer
data TABBED = TABBED deriving (Read, Show, Eq, Typeable)
instance Transformer  TABBED Window where
	transform TABBED x k = k myFTabU (\_ -> x)

-- Floated transformer (W+ctl+f) transfomer
...
myLayoutHook =
	...
	mkToggle (single REFLECTY) $
        onWorkspace  "1" firstLayouts  $    --(myWorkspaces )
	...
	onWorkspace (myWorkspaces !! 4) chatLayouts $
		...
		codeLayouts = (myToggleL myCst2 myCst2Name) ||| (myToggleL myFTabU myFTabName) ||| (myToggleL myTile myTileName) --workspace 3 layouts
		chatLayouts = myToggleL (withIM (0.2) (Title "Buddy List") myMosA) myChatName                                   --workspace 5 layouts
                firstLayouts =
                  (myToggleL myFTabU myFTabName) |||
		...
		allLayouts  =                                                                                                   -- rest of workspaces layouts
			...
			(myToggleL myTile myTileName) |||
			(myToggleL myOneB myOneBName) |||   -- using in coding?
			(myToggleL myMirr myMirrName) |||
			(myToggleL myMosA myMosAName) |||
...
manageWindows = composeAll . concat $
	...
	, [ className =? c --> doShift (myWorkspaces !! 1) | c <- myCodeS    ] --myWebS
	, [ className =? c --> doShift (myWorkspaces !! 2) | c <- myWebS   ]
--myCodeS
...
myBrightL =
	...
	(dzenBoxStyleL whiteBoxPP $ brightPerc 100) --15 because brightness go from 0 to 15 in my case, usually must be 10
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
	...
	, ((0, xF86XK_MonBrightnessUp), spawn "/home/shwsun/bin/bridzen.sh")                                                  --Raise brightness
	, ((0, xF86XK_MonBrightnessDown), spawn "/home/shwsun/bin/bridzen.sh")                                                --Lower brightness
	--, ((0, xF86XK_ScreenSaver), spawn "/home/shwsun/bin/turnoffscreen.sh")                                                --Lock screen
	--, ((modMask .|. shiftMask, xK_l), spawn "slock")
    , ((modMask .|. shiftMask, xK_l), spawn "xautolock -locknow")
    , ((0, 0xff14), spawn "/home/shwsun/bin/turnoffscreen.sh")
	, ((0, xK_Print), spawn "/usr/bin/scrot '%Y-%m-%d_$wx$h.png'" >> flashText myTextConfig 1 " Screenshot Saved ")       --Take a screenshot
	, ((modMask , xK_s), spawn "/home/shwsun/bin/turnoffscreen.sh")                                                       --Turn off screen
